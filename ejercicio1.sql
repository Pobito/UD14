...
--
-- Host: 192.168.1.175    Database: meteo
-- ------------------------------------------------------
...
CREATE TABLE `muestra` (
  ...
  `temepartiramaxima` tinyint DEFAULT NULL,
  ...
  `velocidadmaxima` tinyint unsigned DEFAULT NULL,
...
-- Dump completed on 2021-07-23 10:14:57
